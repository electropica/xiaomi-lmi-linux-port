# Mobian M1 Phosh image

> Current-state note: this document contains chronological M1 bring-up history as well as the active recipe. Earlier milestone limitations are historical unless repeated in `docs/CURRENT-BUILD.md` or a later validation document. See `docs/CURRENT-BUILD.md` for the current validated build and `docs/ARCHITECTURE.md` for current paths.
...
The default build does not install optional applications. Set
`INSTALL_OPTIONAL_APPS=1` when launching the build to install the list in
`apps/scripts/install.sh` inside the prepared chroot, after the direct system
packages. The existing APT update and service-start policy apply to both steps.

```sh
INSTALL_OPTIONAL_APPS=1 unshare --mount \
  --map-users=0:1001:1 \
  --map-users=1:165537:65535 \
  --map-groups=0:1001:1 \
  --map-groups=1:165537:65535 \
...
`docs/validation/mobian-m1-wifi-hardware-validation-2026-09-03.md`. M1 REPRO v2
...
`docs/validation/mobian-m1-repro-v2-host-validation-2026-09-04.md`.
...
`docs/validation/mobian-m1-repro-v2-hardware-validation-2026-09-04.md` for the separate
...
`docs/validation/mobian-m1-repro-v3-hardware-validation-2026-09-04.md`.
...
`docs/validation/mobian-m1-repro-v11-hardware-validation-2026-09-05.md`.
...
`docs/validation/mobian-m1-qca6390-hastings-hci-design-2026-09-05.md` and
`docs/validation/mobian-m1-qca6390-v2-boot-safety-validation-2026-09-06.md`.
